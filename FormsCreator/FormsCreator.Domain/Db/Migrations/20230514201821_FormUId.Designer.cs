...
namespace FormsCreator.Domain.Db.Migrations
{
    ...
    [Migration("20230514201821_FormUId")]
    partial class FormUId
    {
            ...
            modelBuilder.Entity("FormsCreator.Domain.Core.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 14, 22, 18, 20, 989, DateTimeKind.Local).AddTicks(9629),
                            Email = "mateuszcymerman95@gmail.com",
                            IsAdmin = true,
                            Login = "admin",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 14, 22, 18, 20, 992, DateTimeKind.Local).AddTicks(876),
                            Password = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 14, 22, 18, 20, 992, DateTimeKind.Local).AddTicks(1100),
                            Email = "cymekdeveloper@gmail.com",
                            IsAdmin = false,
                            Login = "testowy",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 14, 22, 18, 20, 992, DateTimeKind.Local).AddTicks(1105),
                            Password = "admin"
                        });
                });
