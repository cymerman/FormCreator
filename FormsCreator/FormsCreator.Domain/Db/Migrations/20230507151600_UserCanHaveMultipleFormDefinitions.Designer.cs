...
namespace FormsCreator.Domain.Db.Migrations
{
    ...
    [Migration("20230507151600_UserCanHaveMultipleFormDefinitions")]
    partial class UserCanHaveMultipleFormDefinitions
    {
            ...
            modelBuilder.Entity("FormsCreator.Domain.Core.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 7, 17, 15, 59, 880, DateTimeKind.Local).AddTicks(5324),
                            Email = "mateuszcymerman95@gmail.com",
                            IsAdmin = true,
                            Login = "admin",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 7, 17, 15, 59, 883, DateTimeKind.Local).AddTicks(5190),
                            Password = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 7, 17, 15, 59, 883, DateTimeKind.Local).AddTicks(5422),
                            Email = "cymekdeveloper@gmail.com",
                            IsAdmin = false,
                            Login = "testowy",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 7, 17, 15, 59, 883, DateTimeKind.Local).AddTicks(5428),
                            Password = "admin"
                        });
                });
