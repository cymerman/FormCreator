...
namespace FormsCreator.Domain.Db.Migrations
{
    ...
    [Migration("20230507133936_FormDefinition")]
            ...
            modelBuilder.Entity("FormsCreator.Domain.Core.Security.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 7, 15, 39, 35, 739, DateTimeKind.Local).AddTicks(2660),
                            Email = "mateuszcymerman95@gmail.com",
                            IsAdmin = true,
                            Login = "admin",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 7, 15, 39, 35, 741, DateTimeKind.Local).AddTicks(4678),
                            Password = "admin"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedBy = 1L,
                            CreatedOn = new DateTime(2023, 5, 7, 15, 39, 35, 741, DateTimeKind.Local).AddTicks(4902),
                            Email = "cymekdeveloper@gmail.com",
                            IsAdmin = false,
                            Login = "testowy",
                            ModifiedBy = 1L,
                            ModifiedOn = new DateTime(2023, 5, 7, 15, 39, 35, 741, DateTimeKind.Local).AddTicks(4907),
                            Password = "admin"
                        });
                });
